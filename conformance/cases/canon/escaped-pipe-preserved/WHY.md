...
The file is already canonical, so `canon` must return it byte-for-byte. §10's
canonical form drops alignment padding; it does not touch cell *values*, and the
escape is part of the value's spelling, not decoration.
